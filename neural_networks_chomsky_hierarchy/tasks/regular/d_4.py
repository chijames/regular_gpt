"""Compute whether the input string is D4."""
...
class D4(task.GeneralizationTask):
  """A task which goal is to check whether the input string is D4.

  The input is a binary string, composed of 0s and 1s. If they are (0(0(0(01)*1)*1)*1)*,
