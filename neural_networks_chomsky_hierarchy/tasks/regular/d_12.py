"""Compute whether the input string is D12."""
...
class D12(task.GeneralizationTask):
  """A task which goal is to check whether the input string is D12.

  The input is a binary string, composed of 0s and 1s. Refer to D2~D4 for the definition.
