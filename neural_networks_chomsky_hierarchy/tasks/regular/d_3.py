"""Compute whether the input string is D3."""
...
class D3(task.GeneralizationTask):
  """A task which goal is to check whether the input string is D3.

  The input is a binary string, composed of 0s and 1s. If they are (0(0(01)*1)*1)*,
